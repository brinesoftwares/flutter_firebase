...
class _ForgetPasswordState extends State<ForgetPassword> {
  ...
  _sendToServer() {
    if (_key.currentState.validate()) {
      ...
      Get.back();
      Get.snackbar("Sent Mail", "Password is sent to Your Email",snackPosition: SnackPosition.BOTTOM,barBlur: 50,backgroundColor: Colors.amber,margin: EdgeInsets.all(5));
